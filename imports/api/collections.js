...
const Second = LU ? new Mongo.Collection('a_projects') : new Mongo.Collection('c_research');
const Third = LU ? new Mongo.Collection('a_research') : new Mongo.Collection('c_reading');
